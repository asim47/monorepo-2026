...
export const getMuiColors = (isDarkMode: boolean) => ({
  ...
  background: {
    default: isDarkMode ? getCssVariable('--background') : getCssVariable('--background'),
    paper: isDarkMode ? getCssVariable('--background-paper') : getCssVariable('--background-paper'),
  },
  text: {
    primary: isDarkMode ? getCssVariable('--text-primary') : getCssVariable('--text-primary'),
    secondary: isDarkMode ? getCssVariable('--text-secondary') : getCssVariable('--text-secondary'),
  },
});
